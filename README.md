...
Durante o desenvolvimento do projeto, o Airflow apresentou erros de permissão ao tentar interagir com o filesystem dos desenvolvedores, portanto, sugerimos que executem o comando `chmod -R 777 airflow app/data` após clonar o repositório, dessa forma, os diretórios `airflow` e `app/data` poderão ser acessados pelo Airflow durante a execução do projeto.
